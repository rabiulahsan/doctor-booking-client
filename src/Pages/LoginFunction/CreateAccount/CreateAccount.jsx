      ...
      <div className="flex items-center">
        <div className="doctor-login  w-1/2 min-h-screen bg-slate-200 flex items-center justify-center">
          <div className="text-center w-2/3 mx-auto">
            ...
            <p className="text-slate-700 my-5">
              Manage appointments, connect with patients, and grow your
              practice. Log in or create an account to get started!
            </p>
        ...
        <div className="patient-login  w-1/2 min-h-screen bg-green-100 flex items-center justify-center">
          <div className=" text-center w-2/3 mx-auto">
            ...
            <p className="text-slate-700 my-5">
              Access top doctors anytime! Log in to book appointments, manage
              your health records, and get personalized healthcare easily.
            </p>
